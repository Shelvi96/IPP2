...
/** @brief Ustawia baze.
 * Ustawia bazę przekierowań o podanej nazwie. Tworzy nową bazę, jeśli jeszcze taka
 * nie istnieje, lub ustawia wskaźnik na bazę o tej nazwie
 ...
 * @return false, gdy baza nie istnieje lub true, gdy usuwanie przebiegło pomyślnie.
 */
