        ...
        if (l.type == 4) { // wczytano NEW
            ...
            if (hasNext()) {
                ...
                if (l1.type == 1) { // wczytano id
                    ...
                    if (!delBase(l1.content, l.startChar)) {
                        exit1(l, l1);
                    }
                }
            ...
            if (hasNext()) {
                ...
                if (l1.type == 3) { // wczytano ?
                    if (currentBase != NULL) {
                        PhoneNumbers* pnum =
                            (PhoneNumbers*)phfwdGet(currentBase->base, l.content);
                        printf("%s\n", phnumGet(pnum, 0));
                        phnumDelete(pnum);
                    }
            ...
            if (hasNext()) {
                ...
                if (l1.type == 0 && currentBase != NULL) { // wczytano numer
                    ...
                    int idx = 0;
                    PhoneNumbers* pnum =
                        (PhoneNumbers*)phfwdReverse(currentBase->base, l1.content);
            ...
            if (hasNext()) {
                ...
                if (l1.type == 0 && currentBase != NULL) { // wczytano numer
                    int len = strlen(l1.content) - NUMLEN;
                    if (len < 0) len = 0;
                    printf("%zu\n",
