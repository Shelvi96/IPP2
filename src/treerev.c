...
size_t revFindNonTrivialCountRec (revNode* n, bool* uniqueSet, size_t len, size_t lenCount, size_t liczbaCyfr) {
...
size_t revFindNonTrivialCount(revNode* root, bool* uniqueSet, size_t len, size_t liczbaCyfr) {
